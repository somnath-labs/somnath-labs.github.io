...
function ContactForm() {
	...
	if (success) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "w-full hyper-glass rounded-3xl p-12 border border-emerald-500/40 text-center relative overflow-hidden",
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-72 h-72 bg-emerald-500/15 rounded-full blur-3xl pointer-events-none" }),
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "relative flex flex-col items-center",
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							className: "p-4 rounded-2xl bg-emerald-500/10 border border-emerald-500/40 mb-5 relative",
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "text-soft font-light mb-3 max-w-sm",
							children: "Thank you for reaching out. I'll get back to you within 24-48 hours."
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "inline-flex items-center gap-2 px-4 py-1.5 rounded-full surface-soft border line-soft text-xs accent-emerald font-medium mb-7",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "w-1.5 h-1.5 rounded-full bg-emerald-400 animate-pulse" }), "Check your inbox for a confirmation"]
						}),
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			error && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "mb-6 p-4 bg-rose-950/50 border border-rose-500/40 accent-rose rounded-xl text-sm",
				children: error
			}),
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
							type: "submit",
							disabled: loading,
							className: "flex-1 neon-btn-primary !py-3.5 !rounded-xl disabled:opacity-50 disabled:cursor-not-allowed",
							children: loading ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "animate-spin rounded-full h-5 w-5 border-b-2 border-current" }), "Sending..."] }) : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Send, { size: 18 }), "Send Message"] })
						})
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
...
//#endregion
export { Globe as a, MessageSquare as i, fallbackContactInfo as n, Clock as o, fallbackSocialLinks as r, CircleCheck as s, Contact as t };
