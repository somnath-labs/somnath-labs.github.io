...
import { require_queries } from "./queries.js";
import { require_operators } from "./operators.js";
//#region node_modules/media-engine/src/parser.js
var require_parser = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	function parser(tokens) {
		...
		function walk() {
			...
			if (head.type === "number") return parseInt(head.value);
			if (head.type === "literal") return head.value;
